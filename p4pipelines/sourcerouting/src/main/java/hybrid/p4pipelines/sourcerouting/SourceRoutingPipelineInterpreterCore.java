...
public class SourceRoutingPipelineInterpreterCore extends AbstractHandlerBehaviour
...
//                    .put(Criterion.Type.ETH_TYPE, ETH_TYPE_ID)
    ...
    public PiAction mapTreatment(TrafficTreatment treatment, PiTableId piTableId)
        ...
        throw new PiInterpreterException("no treatment is mapped");
    }
    ...
    public Collection<PiPacketOperation> mapOutboundPacket(OutboundPacket packet)
            throws PiInterpreterException {
        throw new PiInterpreterException("no mapping for OutboundPacket");
    ...
    public InboundPacket mapInboundPacket(PiPacketOperation packetIn, DeviceId deviceId)
            throws PiInterpreterException {
        throw new PiInterpreterException("no mapping for InBoundPacket");
    }
}
