...
let extract_edits_from_model _ =
  ...
  let model =
    Model.of_alist_exn
      ...
      ; ( "?hdr.ipv4.dstAddr_ipv4_fib_mask"
        , Value.big_make (Util.max_int 32, 32) )
      ; ( "?hdr.ipv4.dstAddr_ipv4_rewrite"
        , Value.big_make (Bigint.of_string "0xa008", 32) )
      ; ( "?hdr.ipv4.dstAddr_ipv4_rewrite_mask"
        , Value.big_make (Util.max_int 32, 32) )
      ; ( "?hdr.ipv4.dstAddr_punt"
        , Value.big_make (Bigint.of_string "0x200000", 32) )
      ...
      ; ( "?meta.nexthop_nexthop"
        , Value.big_make (Bigint.of_string "0x226890e0", 32) )
      ; ( "?meta.nexthop_nexthRunop_mask"
        , Value.big_make (Bigint.of_string "0xffffffff", 32) )
      ; ( "ethernet_0_nexthop_32"
        , Value.big_make (Bigint.of_string "0x226890e0", 32) )
      ; ( "ipv4_fib_0_nexthop_32"
        , Value.big_make (Bigint.of_string "0x6d1a0610", 32) )
  ...
  let expected_edits =
    ...
    ; Add
        ...
        , ( [ Match.wildcard "hdr.ethernet.dstAddr" 32
          ...
          , [Value.str_make ("0x226890e0", 32)]
          , 0 ) ) ]
  in
  Edit.of_model phys model |> same_edits expected_edits
