...
let equals _ = Equality.same_values (make (1, 99)) (make (1, 99))

let inequals _ = Equality.diff_values (make (88, 99)) (make (1, 99))

let leq _ = Equality.leq_values (make (88, 100)) (make (99, 100))
...
let add_wrap _ =
  Equality.same_values (make (1, 2)) (add (make (3, 2)) (make (1, 2)))

let sat_add_top _ =
  Equality.same_values (make (3, 2)) (sat_add (make (3, 2)) (make (1, 2)))

let multiply _ =
  Equality.same_values (make (6, 3)) (multiply (make (3, 3)) (make (2, 3)))

let subtract_ok _ =
  Equality.same_values (make (0, 3)) (subtract (make (1, 3)) (make (1, 3)))

let subtract_wrap_0 _ =
  Equality.same_values (make (6, 3)) (subtract (make (0, 3)) (make (1, 3)))

let subtract_wrap _ =
  Equality.same_values (make (6, 3)) (subtract (make (1, 3)) (make (2, 3)))
...
let mask_ok _ =
  Equality.same_values (make (1, 4)) (mask (make (9, 4)) (make (7, 4)))

let xor_ok _ =
  Equality.same_values (make (3, 2)) (xor (make (2, 2)) (make (1, 2)))
...
let shl_truncs _ =
  Equality.same_values (make (2, 2)) (shl (make (3, 2)) (make (1, 2)))

let cast_truncs_larger _ =
  Equality.same_values (make (3, 2)) (cast 2 (make (15, 4)))

let cast_idents_smaller _ =
  Equality.same_values (make (2, 2)) (cast 2 (make (2, 4)))

let resize_resizes _ =
  Equality.same_values (make (2, 2)) (resize (make (2, 4)) 2)

let resize_is_dangerous _ =
  Equality.same_values (unsafe_make (4, 2)) (resize (make (4, 4)) 2)

let slice_ok _ = Equality.same_values (make (3, 2)) (slice 3 1 (make (6, 4)))

let concat_ok _ =
  Equality.same_values (make (101, 8)) (concat (make (6, 4)) (make (5, 4)))
