...
let slicing_microbench () =
  ...
  let edits =
    [ Edit.Add
        ( "staging"
        , ([Match.exact_ "x0" @@ Value.make (5, 8)], [Value.make (44, 8)], 0)
        )
    ; Edit.Add
        ( "meta0"
        , ( [Match.exact_ "meta" @@ Value.make (44, 8)]
          , [Value.make (3, 8)]
          , 0 ) ) ]
  in
  ...
  let inst =
    ...
    @@ [ Edit.Add
           ( "staging"
           , ( [Match.exact_ "x0" @@ Value.make (2, 8)]
             , [Value.make (99, 8)]
             , 0 ) )
       ; Edit.Add
           ( "meta0"
           , ( [Match.exact_ "meta" @@ Value.make (99, 8)]
             , [Value.make (88, 8)]
             , 0 ) ) ]
    @ edits
  in
  StaticSlicing.rule_slice params inst edits cmd |> same_inst expected
