...
let vv_stringmap = testable_string
                     (Util.string_of_strmap ~to_string:(fun (v1,v2) -> Printf.sprintf "(%s, %s)" (Value.to_string v1) (Value.to_string v2)))
                     (Util.StringMap.equal (fun (v1,v2) (v1',v2') -> Value.eq v1 v1' && Value.eq v2 v2'))
