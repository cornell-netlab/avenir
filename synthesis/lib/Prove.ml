...
(* Mostly dealing with the debruijn indices, or z3 bindings- some is residual such as rhovars. Z3.Expr; needs quantified index in quantification list

Convert everything into a term. Expr, test, etc.
Use "type constructor" line 116 ish
transforming test ast, structural recursion over test ast. call recursively on lhs, rhs, combine back together with and_, or_
