...
let rec mkZ3Value v ctx = match v with
...
let rec mkZ3Test t ctx = match t with 
  ...
  | Eq (field, value) -> Z3.Boolean.mk_eq ctx (Z3.Arithmetic.Integer.mk_const_s ctx field)  (mkZ3Value value ctx)
