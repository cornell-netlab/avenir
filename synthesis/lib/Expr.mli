...
(** [bin_ctor e e1 e2] produces a function that combines [e1] and [e2] using the
 ** same toplevel constructor as [e] *)
val bin_ctor : t -> t -> t -> t

(** [un_ctor e e1] produces a function that processes [e1] using the
 ** same toplevel constructor as [e], including integer arguments *)
val un_ctor : t -> t -> t

(** [bin_eval e v1 v2] applies the interpretation function for the toplevel ast
   node of [e] to [v1] and [v2]*)
...
(** [ord e] associates each Ast node type with an integer -- used for normal forms *)
val ord : t -> int
