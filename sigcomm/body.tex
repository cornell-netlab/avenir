...
Figure~\ref{fig:syntax} shows the syntax of the guarded command language that we use in 
this paper.
A single guarded command is of the form $\IF~{b \to e}~\ENDIF$ where $b$ is a Boolean
