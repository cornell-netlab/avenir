...
\todo[inline]{Could there be funny
  situations where this is unsound?  like when theres a functional
  dependency between $\var f_1$ and $\var f_2$ in the given relation?}
