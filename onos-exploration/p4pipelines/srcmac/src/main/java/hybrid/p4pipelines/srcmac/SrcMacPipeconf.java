...
public final class SrcMacPipeconf {
    public static final PiPipeconfId PIPECONF_ID = new PiPipeconfId("srcmac-pipeconf");
    private static final URL P4INFO_URL = SrcMacPipeconf.class.getResource("/sr_mac_p4_16_p4info.txt");
    private static final URL BMV2_JSON_URL = SrcMacPipeconf.class.getResource("/sr_mac_p4_16.json");
    ...
    private PiPipeconf buildPipeconf() throws P4InfoParserException {
        ...
        return DefaultPiPipeconf.builder()
                ...
                .addBehaviour(PiPipelineInterpreter.class, SrcMacPipelineInterpreter.class)
